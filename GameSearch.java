...
public abstract class GameSearch {
    ...
    public abstract double positionEvaluation(Position p, boolean player);
    ...
    protected Vector alphaBetaHelper(int depth, Position p,
        ...
        for (int i=0; i<moves.length; i++) {
            ...
            double value = -((Double)v2.elementAt(0)).doubleValue();
            if (value > beta) {
